...
$html	.= '<tbody>';
$html	.= '<tr class="title">';
$html	.= '	<td colspan="2"><img src="images/jk_logo.gif" /><br/>phpshunfoo demo 2.0 <br/>沃通付接口版本:v2.6<br/>网银支付版本:v1.2</td>';
$html	.= '</tr>';
$html	.= '<tr>';
...
$html	.= '		<input type="radio" name="payType" id="payType_card_muti" class="payType" value="card_muti" ><label for="payType_card_muti">卡类支付(多卡)</label>';
$html	.= '	</td>';
$html	.= '</tr>';
