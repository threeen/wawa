...
<div class="rule-box invite top1">
                ...
                <div class="rule-box invite top3">
                        <a href="javascript:;" class="rule-btn tuichu">退出</a>
                </div>
    ...
    <div class="cool-dialog dialog-pay" style="display:none;">
        <div class="dialog-bd">
            <div class="dialog-content">
                    <div class="pay-list">
                            <a href="/youyunbao/pay.php?amt=5&userid=<?php echo $user['uid'];?>"
                               class="pay-item weui_btn weui_btn_primary" data-url="" zhi='5' target="_self">充值5元 </a>
 
                            <a href="/youyunbao/pay.php?amt=15&userid=<?php echo $user['uid'];?>"
                               class="pay-item weui_btn weui_btn_primary" data-url="" zhi='15' target="_self">充值15元 </a> 
 
                            <a href="/youyunbao/pay.php?amt=30&userid=<?php echo $user['uid'];?>"
                               class="pay-item weui_btn weui_btn_primary" data-url="" zhi='30' target="_self">充值30元 </a> 
 
                            <a href="/youyunbao/pay.php?amt=50&userid=<?php echo $user['uid'];?>"
                               class="pay-item weui_btn weui_btn_primary" data-url="" zhi='50' target="_self">充值50元 </a> 
 
                            <a href="/youyunbao/pay.php?amt=100&userid=<?php echo $user['uid'];?>"
                               class="pay-item weui_btn weui_btn_primary" data-url="" zhi='100' target="_self">充值100元 </a> 
 
                            <a href="/youyunbao/pay.php?amt=200&userid=<?php echo $user['uid'];?>"
                               class="pay-item weui_btn weui_btn_primary" data-url="" zhi='200' target="_self">充值200元 </a> 
                    </div>
