...
<title>UPUPW PHP探针安全版-KANGLE系列环境包</title>
<meta name="keywords" content="php探针,upupw探针,PHP探针安全版,php7探针,phpinfo,php扩展,数据库连接测试" />
<meta name="description" content="upupw php探针安全版兼容最新php7,需成功测试连接本地数据库后才显示phpinfo动态链接页面和网站路径,适用于UPUPW KANGLE系列环境包." />
...
<tr>
<td colspan="6" class="ft"><?=PHP_SAPI .' PHP/'.PHP_VERSION?>不完全包括以上组件,不同PHP版本能适配的外部扩展不同,为了性能以上组件除网站特别要求外没必要全开启!</td>
</tr>
</table>
<table width="100%" class="inp">
<tr>
...
<td width="25%" class="fl"><input type="text" name="mysqlDb" value="" /></td>
</tr>
<tr>
...
<p style="color:#505050; font-size:14px; text-align:center;">&copy;2016 <a href="http://www.upupw.net">UPUPW绿色服务器平台</a> 版权所有</p>
</div>
</body>
</html>
