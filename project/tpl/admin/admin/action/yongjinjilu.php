    ...
    <table class="table table-border table-bordered table-hover table-bg table-sort">
         <thead>
            <tr class="text-c">
                ...
                <th class="text-l">得佣会员</th>
                <th class="text-l" width="150">
                    获取佣金
                </th>

                <th class="text-l">消费会员</th>
                
                <th class="text-l" width="160">
                    抓取金额
                ...
                <!-- <th class="text-l" width="160">提现方式</th> -->
...
if( $DATA ){
    ...
    foreach( $DATA as $ONG ){ 
        ...
        $datashuzu = unserialize($ONG['data']);
...
<tr class="text-l">
                    ...
                    <?php echo $user['name'] ?>
                    <span style="color: red">(<?php echo $ONG['uid'] ?>)</span>
                    ...
                    $user1 = $D -> setbiao('user') -> where( 
                        array( 
                            "uid" => $datashuzu['xiaofeiid'] , 
                        ) 
                    ) -> find();
                    ...
                    <span style="color: red">(<?php echo $user1['uid'] ?>)</span>
                    ...
                    if ($datashuzu['guanxi'] =='1') {

                        echo  $shezhi['1ji'];

                    }elseif ($datashuzu['guanxi'] =='2') {
                        echo  $shezhi['2ji'];
                    }elseif ($datashuzu['guanxi'] =='3') {
                        echo   $shezhi['2ji'];
                    }
...
<script type="text/javascript">
jQuery(function(){
    jQuery(".shenhe").click(function(){
        var zhi = jQuery(this).attr('zhi');
        $.ajax({
            async: true,
            type:"POST",
            url:"?action=ajax",
            data:{action:'tixianshenhe',zhi:zhi},
            dataType:'json',
